...
full_stacked_pred_labels = pd.Series(final_stacked_model.predict(full_stacked_model_data), name = 'Prediction_Label', index = test_data_nonseq_agg.index)
...
full_stacked_pred_proba = pd.Series(full_stacked_pred_proba, name = 'Prediction_Probability', index = test_data_nonseq_agg.index)
